  ...
  var $skinBlue =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-blue" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span class="bg-blue" style="display:block; width: 60%; float: left; height: 40px; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
  ...
  var $skinBlack =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-black" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div class="clearfix"><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span style="display:block; width: 60%; float: left; height: 40px; background: #f4f6f9; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
  ...
  var $skinPurple =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-purple" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span class="bg-purple" style="display:block; width: 60%; float: left; height: 40px; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
  ...
  var $skinGreen =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-green" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span class="bg-green" style="display:block; width: 60%; float: left; height: 40px; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
  ...
  var $skinRed =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-red" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span class="bg-red" style="display:block; width: 60%; float: left; height: 40px; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
  ...
  var $skinYellow =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-yellow" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4);border-radius: 100px;" class="clearfix full-opacity-hover">'
            + '<div><span style="display:block; width: 40%; float: left; height: 40px; background: #262626; border-top-left-radius: 30px;border-bottom-left-radius: 30px;"></span><span class="bg-yellow" style="display:block; width: 60%; float: left; height: 40px; border-top-right-radius: 30px;border-bottom-right-radius: 30px;"></span></div>'
            + '</a>'
